...
export const DOCS_HELP_ANCHORS = {
  ...
  templatesLibrary: ['#the-three-kinds', '#installing-from-the-marketplace', '#saving-something-as-a-template', '#using-a-template', '#where-a-template-came-from', '#templates-are-per-site', '#deleting', '#related'],
