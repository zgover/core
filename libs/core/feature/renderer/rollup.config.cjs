 ...
 * places declaration files at dist/<pkg>/libs/core/feature/renderer/src/index.d.ts,
 * but the default typeDefinitions plugin generates the stub as ./src/index (relative
